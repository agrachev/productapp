...
import ru.agrachev.build.logic.convention.plugins.includeAndroidCoreDependencies
import ru.agrachev.build.logic.convention.plugins.includeTestingDependencies
...
class AndroidLibraryConventionPlugin : Plugin<Project> {
    ...
    override fun apply(target: Project) =
        with(target) {
            ...
            includeTestingDependencies()
            includeAndroidCoreDependencies()
        }
}
